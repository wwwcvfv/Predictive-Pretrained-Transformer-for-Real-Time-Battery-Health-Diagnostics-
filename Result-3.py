...
#
#
sort_new_test =[(12, 'a31'), (13, 'a23'), (14, 'a32'), (15, 'a25'), (16, 'a26'), (17, 'a27')]
names=['8','33','10','2','31','3']
#
...
plt.savefig('Figure/soh_3.tiff', dpi=800, format="tiff")
plt.show()
...
#
plt.savefig('Figure/dsoh_3.tiff', dpi=800, format="tiff")
plt.show()
